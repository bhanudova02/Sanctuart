...
const TopWaveDivider = ({ className }) => (
  <div className={`absolute left-0 w-full h-[60px] md:h-[75px] lg:h-[90px] overflow-hidden ${className || ''}`} aria-hidden="true">
    {/* Layer 1: Backmost, sand/gold tone, largest amplitude */}
    <svg
      className="absolute bottom-0 w-[400%] md:w-[200%] h-full animate-wave-drift-left"
    ...
    <svg
      className="absolute bottom-0 w-[400%] md:w-[200%] h-full animate-wave-drift-right"
...
const BottomWaveDivider = ({ className }) => (
  <div className={`absolute left-0 w-full h-[35px] md:h-[45px] lg:h-[55px] overflow-hidden ${className || ''}`} aria-hidden="true">
    {/* Layer 1: Backmost */}
    <svg className="absolute top-0 w-[400%] md:w-[200%] h-full animate-wave-drift-left" style={{ animationDuration: '24s' }} preserveAspectRatio="none" viewBox="0 0 2880 55" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Layer 2: Middle */}
    <svg className="absolute top-0 w-[400%] md:w-[200%] h-full animate-wave-drift-left" style={{ animationDuration: '32s' }} preserveAspectRatio="none" viewBox="0 0 2880 55" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Layer 3: Front */}
    <svg className="absolute top-0 w-[400%] md:w-[200%] h-full animate-wave-drift-right" style={{ animationDuration: '45s' }} preserveAspectRatio="none" viewBox="0 0 2880 55" xmlns="http://www.w3.org/2000/svg">
